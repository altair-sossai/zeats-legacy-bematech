...
namespace Zeats.Bematech.Impressoras
{
    public static class MP2032
    {
        /*
         ===============================================================================
            ********************************************************************************
        ...
        */
        ...
        /// <param name="tempo">
        ///     INTEIRO Tempo de espera para a impressão. Ex: 5000 = 5 segundos de espera para a inserção do
        ///     documento.
        /// </param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
        ...
        /// <summary>
        ///     Envio de comandos para a impressora, como por exemplo: comandos de Autenticação, comando para Acionamento de
        ///     Gaveta, etc.
        /// </summary>
        ...
        /// <summary>
        ///     Configurar o modelo da impressora não fiscal em uso. IMPORTANTE: Esta função deve ser usada antes da função
        ///     IniciaPorta
        /// </summary>
        /// <param name="model">
        ///     INTEIRO 0 = MP-20 TH, MP-2000 CI ou MP-2000 TH, 1 = MP-20 MI, MP-20 CI ou MP-20 S, 2 = Blocos
        ///     térmicos (com comunicacao serial DTR/DSR), 3 = Bloco 112 mm, 4 = ThermalKiosk, 5 = MP-4000 TH, 7 = MP-4200 TH, 8 =
        ///     MP-2500 TH 0 = Default
        /// </param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
        ...
        /// <summary>
        ///     Configura a quantidade de linhas impressas no extrato, antes de começar a espulsá-lo (eject). A quantidade de
        ///     linhas pode variar de 1 a 150 linhas. O Default é 90 linhas. OBS: SOMENTE UTILIZADA PARA OS BLOCOS IMPRESSORES
        /// </summary>
        ...
        /// <summary>
        ///     Esta função habilita ou desabilita o envio do caracter ETX (03h), que mantém a impressora ocupada até o término da
        ///     impressão de todo o texto (string).
        /// </summary>
        ...
        /// <summary>
        ///     Esta função habilita ou desabilita a quantidade de linhas, configurada na função ConfiguraTamanhoExtrato. Caso esta
        ///     função não for executada, a quantidade de linhas não será a Default (90 linhas), será a quantidade que for enviada.
        ///     OBS: SOMENTE UTILIZADA PARA BLOCOS IMPRESSORES
        /// </summary>
        ...
        /// <summary>
        ///     Seleciona a qualidade de impressão, somente disponível para as impressora não fiscais térmicas e para os blocos
        ///     térmicos.
        /// </summary>
        ...
        /// <param name="Posicao">
        ///     INTEIRO Posição 0 = não imprime os caracteres do código, 1 = caracter acima do código, 2 =
        ///     caracter abaixo do código,  3 = caracter acima e abaixo do código
        /// </param>
        ...
        /// </summary>
        /// <param name="nCorrecaoErros">
        ///     INTEIRO Nível de Correção de Erros - Inteiro entre 0 à 8.
        ///     <param name="altura">
        ///         INTEIRO  entre 1 à 8. Altura do caracter do código (pitch). 1 pitch = altura de 0,125 mm.
        ///         <param name="largura">
        ///             INTEIRO entre 1 à 4. Largura do caracter do código (pitch). 1 pitch = altura de 0,125 mm.
        ///             <param name="nColunasImpressas">
        ///                 INTEIRO entre 0 à 30. "0" (zero) utiliza o máximo de colunas. Caso não caiba na linha a impressora
        ///                 ajusta, automaticamente, para o máximo de colunas permitido na linha.
        ///                 <param name="texto">STRING texto do código que será gerado</param>
        ///                 <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
        ...
        /// <param name="sFileName">STRING com o caminho completo do arquivo contendo o bitmap</param>
        /// <param name="xScale">
        ///     INTEIRO indicando o escalonamento da imagem na horizontal em porcentagem. Ex: 100 (%) indica
        ///     largura atual; 200 (%) indica largura 2 vezes maior; -1 (menos um) indica ajuste da largura na página.
        /// </param>
        /// <param name="yScale">
        ///     INTEIRO indicando o escalonamento da imagem na vertical em porcentagem. Ex: 100 (%) indica altura
        ///     atual; 50 (%) indica metade da altura. Ignorado se parâmetro xScale seja &endash;1 (menos um).
        /// </param>
        /// <param name="iAngle">
        ///     INTEIRO usada para girar o bitmap na impressão. Ex: 0 (°) indica sem rotacionamento da imagem; 45
        ///     (°) indica rotacionar a imagem em 45 graus
        /// </param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
        ...
        /// <param name="iModo">
        ///     INTEIRO modo de impressão da imagem, onde: 0 = normal, 1 = altura dupla, 2 = largura dupla, 3 =
        ///     ambos
        /// </param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
        ...
        /// </summary>
        /// <param name="iModo">
        ///     INTEIRO com o modo de impressão da imagem, onde: 0 = normal, 1 = altura dupla, 2 = largura dupla, 3
        ///     = ambos
        /// </param>
        /// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
        [DllImport("MP2032.dll")]
